...
import (
	...
	"github.com/cxwshawn/goblog/controllers/admin"
	"github.com/cxwshawn/goblog/controllers/blog"
...
func init() {
	...
	// flag.Parse()
	// if config_file != "" {
	// 	beego.AppPath, _ = filepath.Abs(config_file)
	// 	//beego.ParseConfig()
	// } else {
	...
	// beego.AppPath = `/root/Applications/Go/src/github.com/lisijie/goblog`
